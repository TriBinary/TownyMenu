...
class PlotGroupMenu(player: Player, back: Menu) : Menu(player, player.tr("plot-group.title"), 6, back) {
    ...
    override fun build() {
        ...
        if (group != null) {
            groups.add(
                PermissionNodes.TOWNY_COMMAND_PLOT_GROUP_REMOVE,
                Icons.icon(
                    Material.HOPPER,
            ...
            if (TownyUtil.economy) {
                groups.add(
                    PermissionNodes.TOWNY_COMMAND_PLOT_GROUP_FORSALE,
                    Icons.icon(
                        Material.GREEN_BANNER, tr("plot-group.sell"), tr("plot-group.sell-description"),
                        tr(
                            "common.price",
            ...
            groups.add(
                PermissionNodes.TOWNY_COMMAND_PLOT_GROUP_DELETE,
                Icons.icon(
