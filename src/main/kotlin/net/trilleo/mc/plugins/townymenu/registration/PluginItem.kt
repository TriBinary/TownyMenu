 ...
 * the `net.trilleo.mc.plugins.townymenu.items` package (or a subpackage). The item is
...
abstract class PluginItem(val id: String) {
    ...
    companion object {
         ...
         *
         * Namespace `townymenu`, key `custom_item_id`.
         */
        @JvmField
        val ITEM_ID_KEY: NamespacedKey = NamespacedKey.fromString("townymenu:custom_item_id")!!
    }
     ...
     *
     * Use the [net.trilleo.mc.plugins.townymenu.utils.itemStack] DSL for concise item
