 ...
 *
 * Language files live in `plugins/TownyMenu/lang/<id>.yml` (e.g. `en_US.yml`,
 ...
 * inserted verbatim, so escape player-written text with [TownyUtil.name] /
 * [TownyUtil.text] before passing it.
 *
 * ```kotlin
 * player.tr("icon.town.residents", "count" to town.numResidents)
 * ```
 */
object Lang {
