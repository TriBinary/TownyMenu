 ...
 * MiniMessage-formatted string such as `"<gray>[<gold>TownyMenu<gray>]"`.
 *
 * ### Usage
 *
 * ```kotlin
...
object MessageUtil {
     ...
     *
     * [prefixString] may be a plain text string (e.g. `"[TownyMenu]"`) or
     * a MiniMessage-formatted string (e.g. `"<gray>[<gold>TownyMenu<gray>]"`).
