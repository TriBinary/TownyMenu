...
+ Added a town bank menu.
    + Deposit and withdraw money without typing commands.

### Improvements

#### Plot Menu

+ Showed the plot price in the plot info item lore.

### Fixes

#### Nation Menu

+ Fixed the nation member list skipping the last page.
```
